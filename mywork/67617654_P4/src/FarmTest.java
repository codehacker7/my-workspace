...
public class FarmTest {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		// In the previous project we had a animal array which was stored in the file but in this project which 
		// we made  a constructor of AnimalList class so it will be an error
	...
	System.out.println(myFarm.getAnimals().get(0));
		 myFarm.getAnimals().set(0, new Llama()); //you may want to test other linked list methods here  //11
		 System.out.println(myFarm.getAnimals().get(0));
